            ...
            <div class="flex flex-wrap -mx-4 ">
                                    ...
                                    @else
                                        @foreach ($carts as $item)
                                            <tr>
                                                ...
                                                <td class="px-2 py-4 whitespace-nowrap text-sm text-gray-500">Rp {{ number_format($item->price, 0, ',', '.') }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <form action="/update_cart/{{ $item->carts->cart_id }}"
                                                        ...
                                                        <div class="flex items-center justify-center">
                                                            ...
                                                            <input type="number" value="{{ $item->carts->qty }}"
                                                                onchange="ubah{{ $loop->iteration }}()" name="qty"
                                                ...
                                                <td
                                                    ...
                                                    Rp {{ number_format($item->price * $item->carts->qty, 0, ',', '.') }}</td>
                                                <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    ...
                                                    <form action="/delete_cart/{{ $item->carts->cart_id }}" method="POST"
                                                        class="d-inline">
                                                        @method('delete')
                                                        @csrf
                ...
                <div class="w-full lg:w-3/12 px-4 mt-8">
                    ...
                    <div class="bg-white shadow-md   rounded-lg p-5 sticky top-6">
                        ...
                        @if ($errors->any())
                        <div class="mt-4 p-4 bg-red-100 border border-red-400 text-red-500 rounded-lg" role="alert">
                            <strong class="font-bold">Oops! Something Error Happen:</strong>
