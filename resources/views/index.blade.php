...
<body id="top" class="text-blueGray-700 antialiased">
    ...
    <footer class="relative bg-blueGray-200 pt-0 pb-6">
        <div class="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-0 h-0"
            style="transform: translateZ(0px)">
            ...
            <div class="flex flex-wrap items-center md:justify-between justify-center">
                <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                    <div class="text-sm text-blueGray-500 font-semibold py-1">
                        Copyright © <span id="get-current-year"></span> Yoozh by
                        <a href="#top" class="text-blueGray-500 hover:text-blueGray-800">Yoozh Team</a>.
                    </div>
                </div>
            </div>
        </div>
